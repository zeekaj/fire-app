...
export function TransactionsList() {
  ...
  const filteredAndSortedTransactions = useMemo(() => {
    ...
    return filtered;
  }, [transactions, accountFilter, dateFilter, searchTerm, sortField, sortDirection, payeeMap, categoryMap, customStartDate, customEndDate]);
    ...
    <div className="space-y-4">
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-4">
        <div className="flex flex-wrap items-center gap-3">
          ...
          <input
            ...
            className="flex-1 min-w-[200px] px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
          />
      ...
      {filteredAndSortedTransactions.length === 0 ? (
        <div className="bg-gray-50 border border-gray-200 rounded-lg p-8 text-center">
          ...
          <p className="text-sm text-gray-500 mt-1">
            {searchTerm || accountFilter !== 'all' || dateFilter !== 'all' 
